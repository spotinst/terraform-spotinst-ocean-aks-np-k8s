...
| <a name="input_vmsizes_filters_min_data"></a> [vmsizes_filters_min_data](#input\_vmsizes_filters_min_data)                                                              | Minimum number of data disks available.                                                                                                              | `number`            | `null` |    no     |
